...
class XiuConfig:
    def __init__(self):
        ...
        self.sql_time = ["user_id", "type", "create_time", "schedule", "last_check_info_time"]
        self.sql_sect = ["sect_id", "sect_name", "sect_owner", "sect_scale", "sect_used_stone",
        ...
        self.sql_impart = ["impart_hp_per", "impart_atk_per", "impart_mp_per",
