...
class XiuxianDateManage:
  ...
  "fabao_weapon" integer DEFAULT 0
    ...
    def realm_top(self):
        ...
        WHEN level = '准帝境圆满' THEN '07'
        WHEN level = '准帝境中期' THEN '08'
        WHEN level = '准帝境初期' THEN '09'
        WHEN level = '仙王境圆满' THEN '10'
        WHEN level = '仙王境中期' THEN '11'
        WHEN level = '仙王境初期' THEN '12'
        WHEN level = '真仙境圆满' THEN '13'
        WHEN level = '真仙境中期' THEN '14'
        WHEN level = '真仙境初期' THEN '15'
        WHEN level = '至尊境圆满' THEN '16'
        WHEN level = '至尊境中期' THEN '17'
        WHEN level = '至尊境初期' THEN '18'
        WHEN level = '遁一境圆满' THEN '19'
        WHEN level = '遁一境中期' THEN '20'
        WHEN level = '遁一境初期' THEN '21'
        WHEN level = '斩我境圆满' THEN '22'
        WHEN level = '斩我境中期' THEN '23'
        WHEN level = '斩我境初期' THEN '24'
        WHEN level = '虚道境圆满' THEN '25'
        WHEN level = '虚道境中期' THEN '26'
        WHEN level = '虚道境初期' THEN '27'
        WHEN level = '天神境圆满' THEN '28'
        WHEN level = '天神境中期' THEN '29'
        WHEN level = '天神境初期' THEN '30'
        WHEN level = '圣祭境圆满' THEN '31'
        WHEN level = '圣祭境中期' THEN '32'
        WHEN level = '圣祭境初期' THEN '33'
        WHEN level = '真一境圆满' THEN '34'
        WHEN level = '真一境中期' THEN '35'
        WHEN level = '真一境初期' THEN '36'
        WHEN level = '神火境圆满' THEN '37'
        WHEN level = '神火境中期' THEN '38'
        WHEN level = '神火境初期' THEN '39'
        WHEN level = '尊者境圆满' THEN '40'
        WHEN level = '尊者境中期' THEN '41'
        WHEN level = '尊者境初期' THEN '42'
        WHEN level = '列阵境圆满' THEN '43'
        WHEN level = '列阵境中期' THEN '44'
        WHEN level = '列阵境初期' THEN '45'
        WHEN level = '铭纹境圆满' THEN '46'
        WHEN level = '铭纹境中期' THEN '47'
        WHEN level = '铭纹境初期' THEN '48'
        WHEN level = '化灵境圆满' THEN '49'
        WHEN level = '化灵境中期' THEN '50'
        WHEN level = '化灵境初期' THEN '51'
        WHEN level = '洞天境圆满' THEN '52'
        WHEN level = '洞天境中期' THEN '53'
        WHEN level = '洞天境初期' THEN '54'
        WHEN level = '搬血境圆满' THEN '55'
