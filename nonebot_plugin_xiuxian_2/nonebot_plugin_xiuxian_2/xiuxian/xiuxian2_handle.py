...
class XiuxianDateManage:
  ...
  "fabao_weapon" integer DEFAULT 0
    ...
    def realm_top(self):
        ...
        WHEN level = '祭道之上' THEN '01'
        WHEN level = '仙帝境圆满' THEN '02'
        WHEN level = '仙帝境中期' THEN '03'
        WHEN level = '仙帝境初期' THEN '04'
        WHEN level = '准帝境圆满' THEN '05'
        WHEN level = '准帝境中期' THEN '06'
        WHEN level = '准帝境初期' THEN '07'
        WHEN level = '仙王境圆满' THEN '08'
        WHEN level = '仙王境中期' THEN '09'
